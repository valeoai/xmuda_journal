...
# Split for SSDA of Singapore (target dataset)
singapore_train = [
 'scene-0001', 'scene-0002', 'scene-0019', 'scene-0020', 'scene-0021', 'scene-0022', 'scene-0023', 'scene-0024',
 'scene-0025', 'scene-0026', 'scene-0027', 'scene-0028', 'scene-0029', 'scene-0030', 'scene-0031', 'scene-0032',
 'scene-0033', 'scene-0034', 'scene-0041', 'scene-0042', 'scene-0043', 'scene-0044', 'scene-0055', 'scene-0056',
 'scene-0057', 'scene-0058', 'scene-0059', 'scene-0060', 'scene-0061', 'scene-0120', 'scene-0121', 'scene-0122',
 'scene-0123', 'scene-0124', 'scene-0125', 'scene-0126', 'scene-0127', 'scene-0128', 'scene-0129', 'scene-0130',
 'scene-0131', 'scene-0132', 'scene-0133', 'scene-0134', 'scene-0135', 'scene-0138', 'scene-0139', 'scene-0149',
 'scene-0150', 'scene-0151', 'scene-0152', 'scene-0154', 'scene-0155', 'scene-0157', 'scene-0158', 'scene-0159',
 'scene-0160', 'scene-0177', 'scene-0178', 'scene-0179', 'scene-0180', 'scene-0181', 'scene-0182', 'scene-0183',
 'scene-0184', 'scene-0185', 'scene-0187', 'scene-0188', 'scene-0190', 'scene-0191', 'scene-0192', 'scene-0193',
 'scene-0194', 'scene-0195', 'scene-0196', 'scene-0315', 'scene-0316', 'scene-0317', 'scene-0318', 'scene-0350',
 'scene-0351', 'scene-0352', 'scene-0353', 'scene-0354', 'scene-0355', 'scene-0360', 'scene-0361', 'scene-0362',
 'scene-0363', 'scene-0364', 'scene-0365', 'scene-0366', 'scene-0367', 'scene-0368', 'scene-0369', 'scene-0370',
 'scene-0371', 'scene-0372', 'scene-0373', 'scene-0374', 'scene-0375', 'scene-0376', 'scene-0377', 'scene-0378',
 'scene-0379', 'scene-0380', 'scene-0381', 'scene-0382', 'scene-0383', 'scene-0384', 'scene-0385', 'scene-0386',
 'scene-0399', 'scene-0400', 'scene-0401', 'scene-0402', 'scene-0403', 'scene-0405', 'scene-0406', 'scene-0407',
 'scene-0408', 'scene-0410', 'scene-0411', 'scene-0412', 'scene-0413', 'scene-0414', 'scene-0415', 'scene-0416',
 'scene-0417', 'scene-0418', 'scene-0419', 'scene-0420', 'scene-0421', 'scene-0422', 'scene-0423', 'scene-0424',
 'scene-0425', 'scene-0426', 'scene-0427', 'scene-0428', 'scene-0429', 'scene-0430', 'scene-0431', 'scene-0432',
 'scene-0433', 'scene-0434', 'scene-0435', 'scene-0436', 'scene-0437', 'scene-0438', 'scene-0439', 'scene-0945',
 'scene-0947', 'scene-0949', 'scene-0952', 'scene-0953', 'scene-0955', 'scene-0956', 'scene-0957', 'scene-0958',
 'scene-0959', 'scene-0960', 'scene-0961', 'scene-0992', 'scene-0994', 'scene-0995', 'scene-0996', 'scene-0997',
 'scene-0998', 'scene-0999', 'scene-1000', 'scene-1001', 'scene-1002', 'scene-1003', 'scene-1004', 'scene-1005',
 'scene-1006', 'scene-1007', 'scene-1008', 'scene-1009', 'scene-1010', 'scene-1011', 'scene-1012', 'scene-1013',
 'scene-1014', 'scene-1015', 'scene-1016', 'scene-1017', 'scene-1018', 'scene-1019', 'scene-1020', 'scene-1021',
 'scene-1022', 'scene-1023', 'scene-1024', 'scene-1025', 'scene-1045', 'scene-1046', 'scene-1047', 'scene-1048',
 'scene-1049', 'scene-1050', 'scene-1051', 'scene-1052', 'scene-1053', 'scene-1054', 'scene-1055', 'scene-1056',
 'scene-1057', 'scene-1058', 'scene-1074', 'scene-1075', 'scene-1076', 'scene-1077', 'scene-1078', 'scene-1079',
 'scene-1080', 'scene-1081', 'scene-1082', 'scene-1083', 'scene-1084', 'scene-1085', 'scene-1086', 'scene-1087',
 'scene-1088', 'scene-1089', 'scene-1090', 'scene-1091', 'scene-1092', 'scene-1093', 'scene-1094', 'scene-1095',
 'scene-1096', 'scene-1097', 'scene-1098', 'scene-1099', 'scene-1100', 'scene-1101', 'scene-1102', 'scene-1104',
 'scene-1105'
]

train_singapore_labeled = [
 'scene-1090', 'scene-1096', 'scene-0372', 'scene-0151', 'scene-1074', 'scene-1048', 'scene-0961', 'scene-0193',
 'scene-0426', 'scene-0188', 'scene-0002', 'scene-0381', 'scene-0407', 'scene-1045', 'scene-0421', 'scene-0178',
 'scene-0947', 'scene-0139', 'scene-0399', 'scene-0953', 'scene-0154', 'scene-0379', 'scene-0431', 'scene-1079',
 'scene-0191', 'scene-1077', 'scene-0406', 'scene-1095', 'scene-0179', 'scene-0385', 'scene-1012', 'scene-0998',
 'scene-0134', 'scene-0424', 'scene-0436', 'scene-0131', 'scene-0130', 'scene-0949', 'scene-0030', 'scene-0403',
 'scene-0999', 'scene-0121', 'scene-0417', 'scene-0362', 'scene-0412', 'scene-1050', 'scene-0135', 'scene-0023',
 'scene-0423', 'scene-0185', 'scene-0120', 'scene-0123', 'scene-1083', 'scene-0316', 'scene-0960', 'scene-1078',
 'scene-0042', 'scene-0402', 'scene-1087', 'scene-1008', 'scene-1058', 'scene-1004', 'scene-0157', 'scene-0369',
 'scene-0371', 'scene-1085', 'scene-0370', 'scene-0059', 'scene-1002', 'scene-0997', 'scene-0437', 'scene-1075'
]

train_singapore_unlabeled = [
 'scene-0380', 'scene-0021', 'scene-1015', 'scene-0374', 'scene-0028', 'scene-0152', 'scene-1054', 'scene-0367',
 'scene-0361', 'scene-0416', 'scene-0363', 'scene-1019', 'scene-1017', 'scene-1021', 'scene-1013', 'scene-0190',
 'scene-0435', 'scene-0945', 'scene-0022', 'scene-0420', 'scene-1052', 'scene-1055', 'scene-0029', 'scene-0024',
 'scene-0158', 'scene-0384', 'scene-0044', 'scene-0958', 'scene-0061', 'scene-1094', 'scene-1089', 'scene-0125',
 'scene-0368', 'scene-0019', 'scene-0956', 'scene-1082', 'scene-0383', 'scene-0133', 'scene-1047', 'scene-0315',
 'scene-1006', 'scene-0031', 'scene-0318', 'scene-0132', 'scene-1099', 'scene-0138', 'scene-0376', 'scene-0405',
 'scene-0364', 'scene-0353', 'scene-1105', 'scene-0183', 'scene-0177', 'scene-1084', 'scene-0433', 'scene-1100',
 'scene-1088', 'scene-0180', 'scene-0192', 'scene-0375', 'scene-0995', 'scene-0026', 'scene-0129', 'scene-0124',
 'scene-0055', 'scene-0034', 'scene-0410', 'scene-1020', 'scene-0025', 'scene-1051', 'scene-1003', 'scene-0149',
 'scene-1081', 'scene-1000', 'scene-0994', 'scene-1104', 'scene-0996', 'scene-1022', 'scene-0195', 'scene-0439',
 'scene-1009', 'scene-1025', 'scene-0427', 'scene-1007', 'scene-1018', 'scene-0122', 'scene-0196', 'scene-1102',
 'scene-1092', 'scene-0060', 'scene-0414', 'scene-1097', 'scene-0352', 'scene-0043', 'scene-1093', 'scene-0401',
 'scene-0428', 'scene-0127', 'scene-0181', 'scene-0160', 'scene-0434', 'scene-0150', 'scene-0033', 'scene-0354',
 'scene-0182', 'scene-0360', 'scene-0415', 'scene-1046', 'scene-0001', 'scene-0959', 'scene-1001', 'scene-1011',
 'scene-0377', 'scene-1014', 'scene-0056', 'scene-0020', 'scene-0429', 'scene-0032', 'scene-1098', 'scene-0422',
 'scene-0400', 'scene-1101', 'scene-0430', 'scene-0155', 'scene-0992', 'scene-0955', 'scene-0351', 'scene-0386',
 'scene-0365', 'scene-1057', 'scene-0432', 'scene-0408', 'scene-0355', 'scene-1005', 'scene-0041', 'scene-1016',
 'scene-0058', 'scene-0350', 'scene-0128', 'scene-0952', 'scene-1056', 'scene-1010', 'scene-0425', 'scene-0184',
 'scene-1053', 'scene-0957', 'scene-0057', 'scene-1023', 'scene-1086', 'scene-0194', 'scene-0126', 'scene-0418',
 'scene-0159', 'scene-0438', 'scene-0366', 'scene-0411', 'scene-0317', 'scene-1076', 'scene-1049', 'scene-0378',
 'scene-0413', 'scene-0419', 'scene-0187', 'scene-0027', 'scene-0382', 'scene-1091', 'scene-1024', 'scene-0373',
 'scene-1080'
]
